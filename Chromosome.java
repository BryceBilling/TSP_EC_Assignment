...
class Chromosome {
    ...
    Chromosome(Chromosome newChromosome){
        cityList = new int[newChromosome.cityList.length];
        for(int i = 0; i<newChromosome.cityList.length;i++) {
            this.setCity(i,newChromosome.getCity(i));
        }
        this.cost = newChromosome.getCost();
    }
